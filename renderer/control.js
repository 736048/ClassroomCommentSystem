...
socket.on('new_comment', (data) => {
    ...
    div.className = 'history-item'; // Use the class for styling
    div.style.borderBottom = '1px solid #ccc'; // Ensure styling if class isn't enough or overrides
    ...
    // Add text-shadow to the block so white blocks are visible
